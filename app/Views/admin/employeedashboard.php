                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            ...
                            <span class="mr-2">
                                <input type="text" id="percentHomeServiceHaircut" value="<?= $employeedata['percentHomeServiceHaircut']?>" hidden>  
                                <i class="fas fa-circle text-danger"></i> Massage
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">    
                        <form method="post" action="<?= base_url('admin/changeEmployeeStatus/'.$employeedata['id']); ?>">              
                            <?php if($employeedata['status'] == "ACTIVE"): ?>   
                                <p>Deactivating this employee will prevent the employee from being assigned from any appointments.</p>                 
                                <button class="btn btn-danger" type="button" data-toggle="modal" data-target="#confirm-deactivate">DEACTIVATE</button>
                            <?php elseif($employeedata['status'] == "INACTIVE"): ?>
                                <p>Activating this employee will enable this employee from being assigned to any appointments</p>
                                <button class="btn btn-success" type="button" data-toggle="modal" data-target="#confirm-activate">ACTIVATE</button>
                            <?php endif ?>
                            ...
                            <div class="modal fade" id="confirm-activate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">Select "Activate" below if you want to activate this employee.</div>
                            ...
                            <div class="modal fade" id="confirm-deactivate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">Select "Deactivate" below if you want to deactivate this employee.</div>
                                        <div class="modal-footer">
                                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
